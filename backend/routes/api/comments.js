 ...
 */
 ...
 /**
    ...
    * @param {string} request.body.text.required - The text of the comment
    * @param {string} request.body.author.required - The author of the comment
...
router.delete("/:id", async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ message: "Comment deleted successfully" });} catch (error) { }})
